...
> **Status R011-B011: belum lengkap.** Materi pendahuluan, Bab 1–2, pembuka Bab 3, Bagian 3.1, Bagian 3.2 *Peluang bersyarat*, dan Bagian 3.3 *Pengambilan sampel dari populasi kecil* telah diterjemahkan dan diterima. Materi mulai Bagian 3.4 tetap berbahasa Inggris di dalam PDF batas kerja agar build buku penuh dapat direproduksi.

## Baca dan unduh

- [PDF batas kerja R011-B011](output/pdf/statistika-berbasis-data-batas-R011-B011.pdf) — 426 halaman, 22026585 byte, SHA-256 `f5842874239487faec2154324d61897cf2a411529e2a07fbb131e88399d92a4a`.
- [Rilis publik terbaru yang telah diverifikasi, R011-B010](https://doi.org/10.5281/zenodo.22072389) — tetap menjadi versi publik terbaru sampai paket B011 diterbitkan dan dibaca balik.
- [Garis keturunan konsep Zenodo](https://doi.org/10.5281/zenodo.22059801) — menunjuk versi terbaru dari edisi ini.
- [Rilis GitHub publik terbaru, R011-B010](https://github.com/KokunoYumeto/statistika-berbasis-data-id/releases/tag/r011-b010-2026.08.23.1).

## Cakupan yang diterima

- pembuka Bab 3 dan Bagian 3.1 yang telah diterima pada B010;
- Bagian 3.3 lengkap, *Sampling from a small population* / *Pengambilan sampel dari populasi kecil*, dalam urutan sumber;
- 3 contoh bernomor dan 4 latihan terpandu beserta jawaban publik inline;
- latihan akhir bab 23–28;
- jawaban publik 23, 25, dan 27;
- tidak ada aset gambar, kode, atau data baru pada batas ini;
- catatan celah `O001` untuk 24, 26, dan 28.

Tidak ada solusi instruktur terbatas yang diakses, direkonstruksi, atau disajikan seolah-olah berasal dari sumber. Cursor berikutnya adalah Bagian 3.4 pada label `randomVariablesSection`.

## Isi repositori

- `repo/` — penutupan sumber LaTeX dan aset tepat untuk batas R011-B011;
