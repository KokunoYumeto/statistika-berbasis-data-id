...
\begin{align*}
P(\text{tidak semua \resp{RH}})
	= 1 - P(\text{semua \resp{RH}})
	= 1 - 0.624 = 0.376
\end{align*}}

Misalkan variabel \var{dominansi tangan} dan
\var{jenis kelamin} independen,
artinya mengetahui \var{jenis kelamin} seseorang tidak memberikan informasi
berguna tentang \var{dominansi tangan}-nya, dan sebaliknya.
...
\begin{examplewrap}
\begin{nexample}{Jika kita mengocok dek kartu lalu mengambil satu kartu, apakah peristiwa kartu itu hati independen dari peristiwa kartu itu as?}
Probabilitas kartu itu hati adalah $1/4$ dan probabilitas kartu itu as adalah $1/13$. Probabilitas kartu itu as hati adalah $1/52$.
Kita memeriksa apakah $P(A \text{ dan }B) = P(A) \times  P(B)$
terpenuhi:
\begin{align*}
P({\color{redcards}\heartsuit})\times P(\text{as}) = \frac{1}{4}\times \frac{1}{13} = \frac{1}{52} 
					= P({\color{redcards}\heartsuit}\text{ dan as})
\end{align*}
...
\begin{align*}
P(\text{tinggi antara \resp{180} dan \resp{185}})
