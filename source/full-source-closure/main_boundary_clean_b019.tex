...
Pembaca ini berhenti tepat setelah Bagian~5.1,
\emph{Estimasi titik dan variabilitas sampling}. Bagian ini memuat keenam
latihan dan semua jawaban publik yang tersedia dari sumber, yaitu jawaban
untuk latihan 1, 3, dan 5. Jawaban untuk latihan 2, 4, dan 6 memang tidak
tersedia dalam sumber publik dan tidak direka.
...
% Boundary-clean learner reader through Chapter 5, Section 5.1.
...
\appendix{}
\addtocontents{toc}{\protect\setcounter{tocdepth}{0}}\include{extraTeX/eoceSolutions/eoceSolutions_boundary_clean_b019}
\endgroup
