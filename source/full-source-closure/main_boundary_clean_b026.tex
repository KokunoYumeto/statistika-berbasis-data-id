...
% Boundary-clean learner reader through Chapter 7, Section 7.1.
...
\addtocounter{chapter}{-1}
\normalsize
\input{ch_inference_for_means/TeX/ch_inference_for_means}
\endgroup

\begingroup
\include{extraTeX/style/style_appendices}
\appendix{}
\addtocontents{toc}{\protect\setcounter{tocdepth}{0}}\include{extraTeX/eoceSolutions/eoceSolutions_boundary_clean_b026}
\endgroup
