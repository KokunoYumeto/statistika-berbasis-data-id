...
\item[\ref{hypothesisTesting}]
    \datawrap{\datalink{pew\_energy\_2018}}
    Lihat perincian kumpulan data ini sebelumnya,
    pada bagian data di Bagian~\ref{pointEstimates}.
\item[\ref{hypothesisTesting}]
    \datawrap{Pertanyaan keluarga Rosling}
    Kami mencatat sampel yang jauh lebih kecil daripada yang
    dijelaskan keluarga Rosling dalam buku mereka,
    \oiRedirect{amazon_factfulness}{Factfulness}.
    Sampel yang kami uraikan serupa, tetapi tidak
    sama dengan proporsi sebenarnya.
    Perkiraan proporsi jawaban yang benar untuk
    kedua pertanyaan pada populasi yang dibahas dalam buku tersebut
    (yang kadang berbeda), sebagaimana dilaporkan dalam
    \oiRedirect{amazon_factfulness}{Factfulness},
    adalah
    \begin{itemize}
    \item
        ...
        13\% menjawab benar (17\% di AS).
        \oiRedirect{gapm-io-q9}{gapm.io/q9}
    \item
        Jumlah anak di dunia pada tahun 2100:
        9\% menjawab benar.
        \oiRedirect{gapm-io-q5}{gapm.io/q5}
    \end{itemize}
    Berikut beberapa pertanyaan lain beserta perkiraan persentase
    orang yang menjawabnya dengan benar:
    \begin{itemize}
    \item
        Di semua negara berpendapatan rendah di dunia saat ini,
        berapa banyak anak perempuan yang menamatkan sekolah dasar: 20\%, 40\%, atau 60\%?
        Jawaban: 60\%.
        Sekitar 7\% orang menjawab pertanyaan ini dengan benar.
        \oiRedirect{gapm-io-q1}{gapm.io/q1}
    \item
        Berapa harapan hidup penduduk dunia saat ini:
        50 tahun, 60 tahun, atau 70 tahun?
        Jawaban: 70 tahun.
        Di AS, sekitar 43\% orang menjawab pertanyaan ini dengan benar.
...
%        \oiRedirect{gapm-io-q9}{gapm.io/q9}
    \item
        Pada tahun 1996, harimau, panda raksasa, dan badak hitam
        semuanya tercantum sebagai spesies terancam punah.
        Berapa dari ketiga spesies ini yang kini berada dalam
        kondisi lebih kritis:
        dua spesies,
        satu spesies,
        atau tidak satu pun?
        Jawaban: tidak satu pun.
        Sekitar 7\% orang menjawab pertanyaan ini dengan benar.
        \oiRedirect{gapm-io-q11}{gapm.io/q11}
    \item
        Berapa banyak orang di dunia yang memiliki setidaknya
        sedikit akses ke listrik? 20\%, 50\%, atau 80\%.
        Jawaban: 80\%.
        Sekitar 22\% orang menjawab pertanyaan ini dengan benar.
...
\item[\ref{hypothesisTesting}]
    ...
    Sebuah sampel acak sederhana terhadap 1,028 orang dewasa AS pada Maret 2013
    mendapati bahwa 56\% orang dewasa AS mendukung
