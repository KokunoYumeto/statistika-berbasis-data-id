...
{
\begin{itemize}\item[\color{oiB}$\bigodot$]\refstepcounter{equation}\noindent\normalsize\textbf{\color{oiB}Latihan Terbimbing \theexercise}%\hspace{3mm}
...
\selectfont{\MakeUppercase{Contoh~#1}}} \\[1mm]}
\newcommand{\exercisetitle}[1]{\textbf{\color{oiB}\small\fontfamily{phv}%
\selectfont{\MakeUppercase{Latihan Terbimbing~#1}}} \\[1mm]}
...
% 9.3.1 Environment
\newlength{\eoceAfterSpace}
\setlength{\eoceAfterSpace}{4mm}
...
{\textbf{\refstepcounter{eoceNeedSolution} \color{red}TAMBAHKAN SOLUSI. #1}}
\newcommand{\eoceReplace}[1][]
{\textbf{\refstepcounter{eoceReplace} \color{red}GANTI LATIHAN INI. #1}}
\newcommand{\eoceFF}[1][]
...
\addvspace{1mm}}
% 10.2 Tip Box
\newenvironment{tipBoxTitle}[2][KIAT:\ ]{\textbf{\color{oiB}#1#2}\\[0.3mm]}{}
...
\noindent{\color{oiB}\framebox[\textwidth][l]{ \\
	...
	\begin{minipage}[b]{\textwidth-4mm}
		...
		\end{minipage}
		\begin{minipage}[b]{\textwidth-8mm}
			\textbf{\color{oiB}Perhatian: #1} \\[1mm]
			\color{black}#2
		\end{minipage}
	\end{minipage}}}
}{
