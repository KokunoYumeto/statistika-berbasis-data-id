...
%\rule{\textwidth}{0.3pt}
\end{fullminipage}
\markboth{\MakeUppercase{Bab~\thechapter.\ \currentchaptertitle}}{}}
\titleformat{\chapter}
    {}
    {\setupfont{}\setfontsize{\chapterXfontsize}\color{oiB}Bab~\thechapter}% \quad #1}
    {1em}
    {}
    []
\titlespacing{\chapter}
...
\newcommand{\chapterintro}[1]{
  ...
  {\Large\noindent%
  Untuk video, salindia, dan sumber daya lainnya, kunjungi \\[2mm]
...
\newcommand{\reviewexercisesheader}[1][Latihan bab]
  {
    \clearpageforsection
...
\newcommand{\exercisesheader}[1][Latihan]
  {
    \clearpageforsection
