...
text(0.6, 0.9, 'semua variabel')
rect(0.4, 0.8, 0.8, 1)

text(0.25, 0.5, 'numerik')
rect(0.1, 0.4, 0.4, 0.6)
arrows(0.45, 0.78, 0.34, 0.62, length = 0.08)

text(0.9, 0.5, 'kategoris')
...
text(1.14, 0.05, '(kategoris berurutan)', col = COL[6], cex = 0.5)
