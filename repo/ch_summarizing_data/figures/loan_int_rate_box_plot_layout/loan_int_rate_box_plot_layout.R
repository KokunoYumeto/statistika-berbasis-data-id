...
lines(c(0.72, 1.28), rep(y, 2),
      lty = 3, col = '#00000066')
text(2, y - 0.1 * sd(d),
     'batas maksimum kumis', pos = 4, cex = 0.875)

m <- rev(tail(sort(d), 5))
s <- m[1] - 0.3 * sd(m)
arrows(2, s, 1.1, m[1] - 0.2, length = 0.08)
arrows(2, s, 1.1, m[2] + 0.3, length = 0.08)
text(2, s, 'pencilan yang dicurigai', pos = 4, cex = 0.875)
